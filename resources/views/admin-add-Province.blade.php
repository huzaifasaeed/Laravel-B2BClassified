...
<h1 class="text-center title-1"> Add Province Name</h1>
...
<form action="{{ url('/add-new-province' ) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="form-group text-center">
                <label for="sub categorie" class="col-sm-3 control-label">Province</label>

                <div class="col-sm-4">
                    <input type="text" name="province_name" id="province" class="form-control">
                </div>
            </div>
